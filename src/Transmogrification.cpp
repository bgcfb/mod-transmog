...
const char* Transmogrification::GetSlotName(uint8 slot, WorldSession* /*session*/) const
{
    ...
    switch (slot)
    {
        ...
        case EQUIPMENT_SLOT_SHOULDERS: return  "肩甲";// session->GetAcoreString(LANG_SLOT_NAME_SHOULDERS);
        ...
        case EQUIPMENT_SLOT_HANDS: return  "手套";// session->GetAcoreString(LANG_SLOT_NAME_HANDS);
        ...
        case EQUIPMENT_SLOT_RANGED: return  "远程武器";// session->GetAcoreString(LANG_SLOT_NAME_RANGED);
